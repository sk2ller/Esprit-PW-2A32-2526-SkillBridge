...
<div class="container" style="padding-top:2rem;">
  <?php if (!empty($_GET['success_candidature'])): ?>
  <script>
  document.addEventListener('DOMContentLoaded', function () {
    window.SkillBridgeAlerts?.dialog('success', 'Candidature envoyee', 'Votre candidature a bien ete envoyee au client.');
  });
  </script>
  <?php endif; ?>
  ...
  <div style="display:grid; grid-template-columns:1fr 350px; gap:2rem; align-items:start;">
    ...
    <div style="position:sticky; top:calc(var(--nav-height) + 1rem);">
      <div style="background:var(--bg-secondary); border:1px solid var(--border); border-radius:12px; padding:1.5rem; margin-bottom:1rem;">
        ...
        <a href="index.php?page=candidater&id=<?= (int)$offre['id_offre'] ?>" class="btn-outline" style="width:100%; justify-content:center; text-decoration:none; display:inline-flex;">

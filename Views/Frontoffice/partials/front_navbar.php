...
<nav class="front-navbar">
    <div class="wrap">
        ...
        <ul class="front-nav-links">
            ...
            <?php endif; ?>            <?php if (in_array($userRole, [2, 3], true)): ?>
                <li><a class="front-nav-link <?= in_array($currentAction, ['brainstorming_list', 'brainstorming_add', 'list_idees'], true) ? 'active' : '' ?>" href="?action=brainstorming_list"><i class="fas fa-lightbulb"></i> Brainstorming</a></li>
                <li><a class="front-nav-link <?= in_array($currentAction, ['all_idees', 'add_idee', 'edit_idee'], true) ? 'active' : '' ?>" href="?action=all_idees"><i class="fas fa-comments"></i> Idees</a></li>
            <?php endif; ?>
            <?php if ($userRole === 1): ?>

                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    $roleMap = [
                                                        ...
                                                        2 => ['label' => 'Utilisateur', 'color' => 'success'],
                                                        3 => ['label' => 'Freelance',   'color' => 'primary'],
                                                    ];
                                                    $r = $roleMap[$user->getIdRole()] ?? ['label' => 'Inconnu', 'color' => 'secondary'];
                                                    ?>
...
function editUser(id) {
    ...
    .then(data => {
        if (data.success) {
            ...
            swalError('Utilisateur introuvable.');
        }
    })
    .catch(() => swalError('Erreur réseau.'));
}

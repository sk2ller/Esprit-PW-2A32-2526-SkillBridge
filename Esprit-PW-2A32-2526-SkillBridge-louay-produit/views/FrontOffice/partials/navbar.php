  ...
  <div class="navbar-actions">
    ...
    <div class="accounts-dropdown" style="position: relative;">
      ...
      <div class="accounts-menu" id="accountsMenu" style="position: absolute; top: 100%; right: 0; margin-top: 0.5rem; background: var(--bg-secondary); border: 1px solid var(--border); border-radius: 8px; min-width: 220px; box-shadow: 0 8px 24px rgba(0,0,0,0.3); display: none; z-index: 1000; overflow: hidden;">
        ...
        <a href="index.php?page=all_produits" class="accounts-item" style="padding: 0.75rem 1rem; display: flex; align-items: center; gap: 10px; color: var(--text-primary); text-decoration: none; transition: all 0.2s ease; border-left: 3px solid transparent;">
          <i class="fas fa-user" style="font-size: 1rem;"></i>
          <span style="font-weight: 500;">Client</span>
        </a>
        
        <a href="index.php?role=vendeur&page=mes_produits" class="accounts-item" style="padding: 0.75rem 1rem; display: flex; align-items: center; gap: 10px; color: var(--text-primary); text-decoration: none; transition: all 0.2s ease; border-left: 3px solid <?= ($_SESSION['role'] ?? '') === 'vendeur' ? 'var(--accent-purple-light)' : 'transparent' ?>; background: <?= ($_SESSION['role'] ?? '') === 'vendeur' ? 'rgba(124, 58, 237, 0.1)' : 'transparent' ?>;">
          <i class="fas fa-store" style="font-size: 1rem;"></i>
          <span style="font-weight: 500;">Vendeur</span>
        </a>
